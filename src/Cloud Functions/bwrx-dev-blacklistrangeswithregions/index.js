...
exports.getblacklistrangeswithregions = (req, res) => {
    ...
    mysqlPool.query(`select ipaddressrange, region from blacklistrangeswithregions limit ` + startpage + `,` + endpage + `;`, (err, results) => {
        if (err) {
            console.error(err);
